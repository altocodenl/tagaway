...
// **
   ...
   ['.home-add-tag-modal-left-section', {
      ...
      'border-right-color':  CSS.vars ['grey--light'],
...
var svg = {
   ...
   deleteHomeBoxIcon: '<svg class="home-add-tag-modal-delete-box-icon" height="24" width="24"><circle cx="10" cy="10" r="10" fill="#ff5b6eff" /><line x1="3" y1="10" x2="17" y2="10" style="stroke:white;stroke-width:2" /></svg> ',
                        ...
                        ['ul', {class: 'tag-list tag-list--attach home-add-tag-modal-your-tags-list-ul'}, [
                           ['li', {class: 'tag-list__item tag home-add-tag-modal-your-tags-list-li'}, [
                              ...
                              ['div', {class: 'home-add-tag-modal-your-tags-actions'}, [
                                 H.putSvg('homeBoxModalArrowGrey', 24),
                                 H.putSvg('homeBoxModalArrowBlue', 24),
                                 H.putSvg('deleteHomeBoxIcon', 24)
                              ]]
                           ]],
                           ['li', {class: 'tag-list__item tag home-add-tag-modal-your-tags-list-li'}, [
