...
dale.go (CSS.vars.tagColors, function (color) {
   ...
   svg ['tagItem' + color] ='<svg class="tag__icon" enable-background="new 0 0 24 24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill="' + color + '" d="m18.6 10.8c0 .5-.1 1.1-.5 1.5l-5 5.9c-.4.5-1 .7-1.5.7s-.9-.2-1.3-.5l-3.8-3.2c-.8-.7-.9-2-.2-2.8l5-5.9c.3-.4.8-.7 1.3-.7l3.5-.3c1.1-.1 2.1.7 2.2 1.8z"/><circle cx="13" cy="18" r="4" stroke="white" stroke-width="1" fill="' + color + '"/><line x1="11" y1="17.5" x2="13" y2="19.5" style="stroke:rgb(255,255,255);stroke-width:1" /><line x1="12.5" y1="19.3" x2="15" y2="17" style="stroke:rgb(255,255,255);stroke-width:1" /></svg>',
