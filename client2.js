...
views.open = function () {
   return B.view ([['State', 'open'], ['Data', 'pivs']], function (open, pivs) {
      ...
      return ['div', {class: 'fullscreen'}, [
         // TODO v2: add inline SVG
         ['div', {class: 'fullscreen__close', opaque: true, onclick: B.ev ('exit', 'fullscreen')}],
         // TODO v2: add inline SVG
         ['div', {class: 'fullscreen__nav fullscreen__nav--left', opaque: true, onclick: B.ev ('open', 'prev')}],
         // TODO v2: add inline SVG
         ['div', {class: 'fullscreen__nav fullscreen__nav--right', opaque: true, onclick: B.ev ('open', 'next')}],
                        ...
                        B.view (['Data', 'account'], function (account) {
                           ...
                           return ['div', {class: 'upload-box__section'}, [
                              ...
                              ['div', {class: 'drag-and-drop-import', opaque: true}, [
                                 ['div', dale.go ([{provider: 'google', class: 'google-drive-logo'}, {provider: 'dropbox', class: 'dropbox-logo'}], function (provider) {
                                    ...
                                    var attrs = function (ev) {
                                       return {style: style ({cursor: 'pointer', float: 'left', display: 'inline-block', 'margin-right': 35}), class: provider.class, onclick: B.ev (ev)};
                                    }
