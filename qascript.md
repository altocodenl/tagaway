...
COUNTRY>YEAR>CITY
			...
			- Click on icon with 'x' on CITY tag below the title.
			- Gallery should thumbnails correspondy to CONTRY and year semi tags. 
			- Click on icon with 'x' on year tag below the title.
			- Gallery should thumbnails correspondy to CONTRY tags.
			- Click on icon with 'x' on COUNTRY tag below the title.
			- Should be back to 'all pictures'.
...
COUNTRY>CITY>YEAR
			...
			- Gallery should thumbnails correspondy to CONTRY + CITY and year semi tags. 
			- Click on icon with 'x' on CITY tag below the title.
			- Gallery should thumbnails correspondy to CONTRY tags.
			- Click on icon with 'x' on COUNTRY tag below the title.
			- Should be back to 'all pictures'.
